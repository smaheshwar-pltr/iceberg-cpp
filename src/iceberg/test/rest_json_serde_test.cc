    ...
    ::testing::Values(
        ...
        LoadTableResultParam{
            ...
            .model = {.metadata = MakeSimpleTableMetadata(),
                      .storage_credentials =
                          {{.prefix = "s3://bucket/",
                            .config = {{"s3.access-key-id", "AKIA1234"},
...
INSTANTIATE_TEST_SUITE_P(
    ...
    ::testing::Values(
        ...
        // Storage credential missing required prefix field
        LoadTableResultInvalidParam{
